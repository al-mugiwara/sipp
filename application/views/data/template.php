        ...
        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="<?=base_url('kader/Kader');?>"><i class="bi bi-circle"></i>Data Kader</a>
                </li>
                <li> <a href="<?=base_url('kader/Bidan');?>"><i class="bi bi-circle"></i>Data Bidan</a>
                </li>
                <li> <a href="<?=base_url('kader/Balita');?>"><i class="bi bi-circle"></i>Data Balita</a>
                </li>
                <li> <a href="<?=base_url('kader/Bumil');?>"><i class="bi bi-circle"></i>Data Ibu Hamil</a>
                </li>
                </li><li> <a href="<?=base_url('kader/Pengumuman');?>"><i class="bi bi-circle"></i>Data Pengumuman</a>
                </li>                
              </ul>
            </li>
            <li class="menu-label">Kelola Kegiatan</li>
            <li>
              <a href="javascript:;" class="has-arrow">
              ...
              <ul>
                <li> <a href="<?=base_url('kader/Vitamin');?>"><i class="bi bi-circle"></i>Pemberian Vitamin</a>
                </li>
                <li> <a href="<?=base_url('kader/Imunisasi');?>"><i class="bi bi-circle"></i>Pemberian Imunisasi</a>
                </li>
                 <li> <a href="<?=base_url('kader/PemBalita');?>"><i class="bi bi-circle"></i>Pemeriksaan Balita</a>
                </li>
                <li> <a href="<?=base_url('kader/PemBumil');?>"><i class="bi bi-circle"></i>Pemeriksaan Ibu Hamil</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="<?=base_url('kader/Laporan');?>"><i class="bi bi-circle"></i>Laporan Kegiatan</a>
                </li>
                <li> <a href="<?=base_url('kader/Laporan/balita')?>"><i class="bi bi-circle"></i>Laporan Balita</a>
                </li>
                <li> <a href="<?=base_url('kader/Laporan/bumil')?>"><i class="bi bi-circle"></i>Laporan Ibu Hamil</a>
                </li>
