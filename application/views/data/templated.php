...
<script>
  <?php 
  $berhasil = $this->session->userdata('berhasil');
  if($berhasil){
   ?>
...
<aside class="sidebar-wrapper" data-simplebar="true">
  ...
  <ul class="metismenu" id="menu">
    ...
    <li>
      ...
      <ul>
        <li> <a href="<?=base_url('kader/Bidan');?>"><i class="bi bi-circle"></i>Data Bidan</a>
        </li>
        <li> <a href="<?=base_url('kader/Bumil');?>"><i class="bi bi-circle"></i>Data Ibu Hamil</a>
        </li>
