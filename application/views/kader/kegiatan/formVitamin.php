    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="p-4 border rounded">
          <form class="row g-3" action="<?=base_url('kader/Vitamin/simpan');?>" method="post">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <label for="validationDefault02" class="form-label">Jenis Vitamin</label>
              <input type="text" class="form-control" id="validationDefault02" required name="vitamin"  placeholder="Masukan Jenis Vitamin">
