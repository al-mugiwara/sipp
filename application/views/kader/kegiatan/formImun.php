...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
  <div class="breadcrumb-title pe-3">Form Imunisasi</div>
  <div class="ps-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">Form Imunisasi</li>
      </ol>
    </nav>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="p-4 border rounded">
          <form class="row g-3" action="<?=base_url('kader/Imunisasi/simpan');?>" method="post">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <label for="validationDefault02" class="form-label">Jenis Imunisasi</label>
              <select class="single-select" name="imun" id="imun">
                <option value="">Pilih Jenis Imunisasi</option>
                <option value="HB 0">HB 0</option>
                <option value="BCG">BCG</option>
                <option value="Polio 1">Polio 1</option>
                <option value="DPT/HB">DPT/HB</option>
                
              </select>
              <input type="hidden" name="umur" id="inumur">
            </div>
            <div class="col-md-12">
              <label for="validationDefaultUsername" class="form-label">Tanggal Pemberian</label>
              <input type="date" class="form-control" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" required name="tglPemberian"  placeholder="Masukan Password" value="<?=date('Y-m-d');?>">
            </div>
