...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
  ...
  <div class="ms-auto">
    <div class="btn-group">
      <a href="<?=base_url('kader/Balita/form/add')?>" class="btn btn-primary px-5"><i class="bi bi-person-circle"></i>&nbsp;Tambah Data</a>
    </div>
  </div>
</div>
<!--end breadcrumb-->
...
<div class="card">
 ...
 <div class="table-responsive mt-3">
   <table class="table align-middle">
    ...
    <tbody>
      <?php $no=1; foreach ($balita->result() as $b):?>
     <tr>
      <td><?=$no++;?></td>
      <td><?=$b->nama;?></td>
      <td><?=$b->nama_ayah;?></td>
      ...
      <td>
        ...
        <button type="button" class="btn btn-primary btn-sm position-relative me-lg-5"><i class="lni lni-checkmark-circle"></i>Ada </button>
      <?php endif; ?>
      <?php if($b->status_kia == "TIDAK ADA"): ?>
        <button type="button" class="btn btn-danger btn-sm position-relative me-lg-5"><i class="lni lni-cross-circle"></i> Tidak Ada </button>
      <?php endif; ?>
    </td>
      <td>
       <div class="table-actions d-flex align-items-center gap-3 fs-6">
         ...
         <a href="<?=base_url('kader/Balita/form/edit/')?><?=$b->id_user;?>" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="bi bi-pencil-fill"></i></a>
